...
if __name__ == '__main__':
    ...
    parameters = {
        'ConvNNet' : [
                {'epochs':5,'batch_size':64,'filter1': 32, 'filter2': 64, 'filter3': 128, 'filter4': 128},     
                {'epochs':5,'batch_size':128,'filter1': 32, 'filter2': 64, 'filter3': 128, 'filter4': 128},
                {'epochs':10,'batch_size':128,'filter1': 32, 'filter2': 64, 'filter3': 128, 'filter4': 128},
                {'epochs':10,'batch_size':64,'filter1': 32, 'filter2': 64, 'filter3': 128, 'filter4': 128}
        ]
        }
